...
base_directory = '/home/work/colonoscopy_data/dataset/class6/supervised_learning/train/'  # 'base' 폴더 경로를 지정합니다.
...
base_directory = '/home/work/colonoscopy_data/dataset/class6/supervised_learning/test/'  # 'base' 폴더 경로를 지정합니다.
total_files = count_files_in_directory(base_directory)
print(f'Total number of files in the base directory and all subdirectories: {total_files}')

train_dataset = datasets.ImageFolder('/home/work/colonoscopy_data/dataset/class6/supervised_learning/train/', transform=train_transform)
test_dataset = datasets.ImageFolder('/home/work/colonoscopy_data/dataset/class6/supervised_learning/test/', transform=test_transform)
...
model = timm.create_model('vit_small_patch16_224', pretrained=True, num_classes=6)
...
for epoch in range(200):
    ...
    save_model(epoch, model, optimizer, path=f'/home/work/colonoscopy_data/dataset/supervised_learning/class6_result/model_epoch_{epoch+1}.pth')

    # Check early stopping condition
    if validation_accuracy > best_val_accuracy:
        best_val_accuracy = validation_accuracy
        epochs_no_improve = 0
        save_model(epoch, model, optimizer, path='/home/work/colonoscopy_data/dataset/supervised_learning/class6_result/best_model.pth')
    else:
        epochs_no_improve += 1
...
# Load the best model
checkpoint = torch.load('/home/work/colonoscopy_data/dataset/supervised_learning/class6_result/best_model.pth')
...
plt.ylim([0, 100])
plt.legend()
plt.savefig('Acc_supervised_6class')
plt.show()