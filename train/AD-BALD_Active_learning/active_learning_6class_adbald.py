...
def train_model(model, train_loader, val_loader, criterion, optimizer, device, epochs, patience=10):
    ...
    for epoch in range(epochs):
        ...
        if val_acc > best_acc:
            best_acc = val_acc
            torch.save(model.state_dict(), 'class6_best_admodel_0819.pth')
...
def bald_query_with_threshold(model, samples_loader, n_drop=10, uncertainty_threshold=0.3, device='cuda'):
...
def evaluate_model_with_cm(model, test_loader, device, criterion, round_num, categories):
    ...
    # Confusion matrix
    cm = confusion_matrix(all_labels, all_preds)
    plot_confusion_matrix(cm, categories, round_num, accuracy, f'6class_confusion_matrix_round_{round_num}.png')
    
    return accuracy, avg_loss, cm


train_dir = '/home/work/tmchoi/dataset/class6/semi_active_learning/train/train6/'
val_dir='/home/work/tmchoi/dataset/class6/semi_active_learning/train/val6/'
test_dir = '/home/work/tmchoi/dataset/class6/semi_active_learning/test1/'
unlabeled_dir = '/home/work/tmchoi/dataset/class6/semi_active_learning/train/unlabeled_6class/'
categories = ['bad_light', 'blurry', 'bubble', 'obstacles', 'tool', 'wall']
...
dropout_p = 0.5
base_model = timm.create_model('vit_small_patch16_224', pretrained=True, num_classes=6)
...
plt.title('Certain Data Points Over Rounds')
plt.grid(True)
plt.savefig('/home/work/colonoscopy_data/dataset/active_learning_result/valyes/class6/Acc_all_split_active_learning_6class_valyes.png')"""
...
plt.ylim([40, 100])
plt.grid(True)
plt.savefig('/home/work/tmchoi/dataset/active_learning_result/valyes/class6/Acc_all_split_active_learning_6class_1025_1.png')
